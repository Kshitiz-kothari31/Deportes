...
public class Basketball extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b_passing = findViewById(R.id.basketball_passing);
        ...
        b_shooting = findViewById(R.id.basketball_shooting);
        ...
        b_dribbling = findViewById(R.id.basketball_dribbling);
        ...
        b_footwork = findViewById(R.id.basketball_footwork);
        ...
        b_running = findViewById(R.id.basketball_running);
        ...
        b_jumping = findViewById(R.id.basketball_jumping);
    ...
    private void playVideo(int index)
    {
        ...
        {
            Intent intent = new Intent(Basketball.this, Video.class);
