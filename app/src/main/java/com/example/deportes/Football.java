...
public class Football extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        f_passing = findViewById(R.id.football_passing);
        ...
        f_dribbling = findViewById(R.id.football_Dribbling);
        ...
        f_shooting = findViewById(R.id.football_Shooting);
        ...
        f_controlling = findViewById(R.id.football_Controlling);
        ...
        f_header = findViewById(R.id.football_Header);
        ...
        f_chest_control = findViewById(R.id.football_Chest_Controlling);
    ...
    private void playVideo(int index)
    {
        ...
        {
            Intent intent = new Intent(Football.this, Video.class);
